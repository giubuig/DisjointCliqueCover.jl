...
A graph can admit multiple minimal edge clique covers and finding one of them is known to be a NP-complete problem [[2](#Reference)]. Therefore, approximate heuristics are needed to estimate it in large graphs.
